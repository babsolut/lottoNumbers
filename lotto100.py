...
for i in range(0,6):
    ...
    while(number in userNumbers is number<1 or number>100):
...
print(f"The number(s) won are {finalNumbers}")
if counter > 2:
    print(f"Congratulations you won {counter} numbers, Your cash prize is waiting for you")
